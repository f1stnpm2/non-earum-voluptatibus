# @f1stnpm2/non-earum-voluptatibus

> forked from [@f1stnpm2/non-earum-voluptatibusode](https://www.npmjs.com/package/@f1stnpm2/non-earum-voluptatibusode) v11.1.0. as the original repository seems [no longer maintained](https://github.com/mysticatea/@f1stnpm2/non-earum-voluptatibusode/issues/300).

[![npm version](https://img.shields.io/npm/v/@f1stnpm2/non-earum-voluptatibus.svg)](https://www.npmjs.com/package/@f1stnpm2/non-earum-voluptatibus)
[![Downloads](https://img.shields.io/npm/dm/@f1stnpm2/non-earum-voluptatibus.svg)](https://www.npmjs.com/package/@f1stnpm2/non-earum-voluptatibus)
[![Build Status](https://github.com/f1stnpm2/non-earum-voluptatibus/workflows/CI/badge.svg)](https://github.com/f1stnpm2/non-earum-voluptatibus/actions)
...
```sh
npm install --save-dev eslint @f1stnpm2/non-earum-voluptatibus
```
...
```js
const nodePlugin = require("@f1stnpm2/non-earum-voluptatibus")
...
💼 [Configurations](https://github.com/f1stnpm2/non-earum-voluptatibus#-configs) enabled in.\
☑️ Set in the `flat/recommended` [configuration](https://github.com/f1stnpm2/non-earum-voluptatibus#-configs).\
🟢 Set in the `flat/recommended-module` [configuration](https://github.com/f1stnpm2/non-earum-voluptatibus#-configs).\
✅ Set in the `flat/recommended-script` [configuration](https://github.com/f1stnpm2/non-earum-voluptatibus#-configs).\
☑️ Set in the `recommended` [configuration](https://github.com/f1stnpm2/non-earum-voluptatibus#-configs).\
🟢 Set in the `recommended-module` [configuration](https://github.com/f1stnpm2/non-earum-voluptatibus#-configs).\
✅ Set in the `recommended-script` [configuration](https://github.com/f1stnpm2/non-earum-voluptatibus#-configs).\
...
`@f1stnpm2/non-earum-voluptatibus` follows [semantic versioning](http://semver.org/) and [ESLint's Semantic Versioning Policy](https://github.com/eslint/eslint#semantic-versioning-policy).
...
- [GitHub Releases](https://github.com/f1stnpm2/non-earum-voluptatibus/releases)
